...
<nav id="navbar-example2" class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    <a class="navbar-brand" href="#">Bipa.id</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ml-auto">
        <a class="nav-item nav-link" href="#yourbenefit">Your Benefit</a>
        <a class="nav-item nav-link" href="#ourprograms">Our Programs</a>
        <a class="nav-item nav-link" href="#ourtutors">Our Tutors</a>
...
<!-- Your Benefit -->
  <section class="yourbenefit" id="yourbenefit">
    <div class="container">
      <h3 class="text-center">Your Benefits</h3>
      <div class="row justify-content-center">
        <div class="col justify-content-center d-flex">
          <figure class="figure">
            <img src="<?=base_url()?>assets/images/avatar-blank.jpg" class="figure-img img-fluid rounded-circle" alt="">
            <figcaption class="figure-caption">
              <h5 class="text-center">Manage Schedule by Yourself</h5>
            </figcaption>
          </figure>
        </div>
        ...
        <div class="col justify-content-center d-flex">
          <figure class="figure">
            <img src="<?=base_url()?>assets/images/avatar-blank.jpg" class="figure-img img-fluid rounded-circle" alt="">
            <figcaption class="figure-caption">
              <h5 class="text-center">Decide your goal lesson</h5>
            </figcaption>
          </figure>
        </div>
        ...
        <div class="col justify-content-center d-flex">
          <figure class="figure">
            <img src="<?=base_url()?>assets/images/avatar-blank.jpg" class="figure-img img-fluid rounded-circle" alt="">
            <figcaption class="figure-caption">
              <h5 class="text-center">Connecting with native speaker tutors</h5>
            </figcaption>
          </figure>
        </div>
        ...
        <div class="col justify-content-center d-flex">
          <figure class="figure">
            <img src="<?=base_url()?>assets/images/avatar-blank.jpg" class="figure-img img-fluid rounded-circle" alt="">
            <figcaption class="figure-caption">
              <h5 class="text-center">Tested method</h5>
            </figcaption>
          </figure>
        </div>
      </div>
...
<!-- Our Program -->
  <section class="ourprograms" id="ourprograms">
    <div class="container">
      <br>
      ...
      <div class="row justify-content-center">
        <div class="col justify-content-center d-flex">
          <figure class="figure">
            <h4>1st Program</h4>
            <img src="<?=base_url()?>assets/images/avatar-blank.jpg" class="figure-img img-fluid rounded" alt="">
            <figcaption class="figure-caption">
...
<!-- Out tutors -->
  <section class="ourtutors" id="ourtutors">
    <div class="container">
    <br>
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Anwar Ali</h5>
              <figure class="figure">
              <img src="<?=base_url()?>assets/images/rating-black.png" class="figure-img img-fluid" alt="" style="width:110px">
              </figure>
              <div class="row justify-content-center">
                <div class="col d-flex justify-content-center">
                  <a href="#" class="btn btn-dark">View Profil</a>
                </div>
              </div>
            </div>
          </div>
